...
const JobFormPage2 =({formData,setFormData})=>{
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
       ...
       <label for="company" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white" >Apply type</label>
       <div className="flex gap-10">
       <div class="flex items-center mr-4">
        <input id="inline-radio" type="radio" value="QuickApply" name="applyType" onChange={(e)=>{handleOnChange(e)}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"/>
    ...
    <div class="flex items-center mr-4 block mb-2">
        <input id="inline-2-radio" type="radio" name="applyType" value="ExternalApply" onChange={(e)=>{handleOnChange(e)}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500  dark:ring-offset-gray-800  dark:bg-gray-700 dark:border-gray-600"/>
